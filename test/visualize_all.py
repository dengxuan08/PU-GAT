...
import os, sys
sys.path.append("../")
from upsampling.utils.pc_util import draw_point_cloud

parser = argparse.ArgumentParser(description="Arg parser")
parser.add_argument('--data_dir', type=str, required=False, default="/home/dx/PycharmProjects/PUGNN/data/test/input_256/input_256")
parser.add_argument('--exp_name',type=str, required=False, default="size256-")
...
if __name__=="__main__":
    ...
    for file in pcd_list:
        ...
        image_save_path=os.path.join(image_save_dir,file_name+"ori.png")
